      ...
      <section>
        ...
        <ol className="list-decimal pl-5 space-y-2">
          ...
          <li>
            ...
            환불의 대상이 되지 않습니다. 제공자는 유효기간 만료 예정 사실을
            마이페이지 등 서비스 화면을 통해 안내하며, 유료 결제 이력이 있는
            계정에 대해서는 만료 예정을 이용자가 등록·인증한 이메일로도
            안내합니다. 유료 결제 이력이 없는 계정의 만료 예정 이메일 안내는
            「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에 따른 광고성
            정보 수신에 동의한 이용자에게 제공됩니다. 이용자의 수신 환경
            등으로 안내를 수신·확인하지 못한 경우에도 소멸의 효력에는 영향이
            없습니다.
          </li>
        </ol>
      </section>
      ...
      <section>
        ...
        <ol className="list-decimal pl-5 space-y-2">
          ...
          <li>
            ...
            약관, 적용일자 및 변경사유를 이용자가 등록·인증한 이메일 등으로
            개별 고지합니다.
          </li>
        </ol>
      </section>
