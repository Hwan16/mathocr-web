    ...
    <div className="space-y-8 text-sm text-zinc-600 leading-relaxed">
      ...
      <section>
        ...
        <ol className="list-decimal pl-5 space-y-2">
          ...
          <li>
            유료로 충전한 크레딧 중 사용하지 아니한 부분에 대하여, 이용자는
            「전자상거래 등에서의 소비자보호에 관한 법률」 등 관련 법령에 따라
            구매일로부터 7일 이내에 청약을 철회하고 환불을 요청할 수 있습니다.
            이미 변환에 사용(소진)된 크레딧은 콘텐츠의 제공이 개시된 것으로
            보아 환불이 제한될 수 있습니다.
          </li>
          <li>
            충전한 크레딧에 유효기간을 두는 경우, 제공자는 충전 시점에 이를
            명확히 고지하며, 유효기간 및 잔여 크레딧의 환불은 관련 법령이
            정하는 범위 내에서 처리됩니다.
          </li>
        </ol>
      </section>
