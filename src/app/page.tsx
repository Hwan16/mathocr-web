        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          ...
          <div className="reveal max-w-lg mx-auto">
            <div className="bezel-card rounded-2xl p-8 md:p-10 text-center">
              ...
              <a
                href="https://github.com/Hwan16/mathocr-web/releases/download/v1.1.8/MathOCR-Setup-v1.1.8.exe"
              ...
              >
                ...
                다운로드
                <span className="text-sm opacity-70 ml-1">v1.1.8 (120MB)</span>
              </a>
              ...
              <p className="text-xs text-zinc-600 mt-6 leading-relaxed">
                설치 시 보안 경고가 나타나면{" "}
                <span className="text-zinc-400">&ldquo;추가 정보&rdquo;</span> →{" "}
                <span className="text-zinc-400">&ldquo;실행&rdquo;</span>을 클릭해주세요.
              </p>
