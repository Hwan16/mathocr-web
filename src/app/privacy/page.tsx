    ...
    <div className="space-y-8 text-sm text-zinc-600 leading-relaxed">
      ...
      <section>
        ...
        {/* 아래 메타 픽셀 국외 이전 블록 — 위 위탁 이전과 달리 서비스 기능과
            ...
            반드시 이 위치보다 앞에 둘 것.
            Meta 이전의 법적 근거·정보관리책임자 연락처는 계약 문서 확인 후
            보완 예정(2026-07-22 검토) */}
        ...
        <ul className="list-disc pl-5 space-y-2">
          <li>
            <strong className="text-zinc-900">이전받는 자:</strong> Meta
            Platforms, Inc.
          </li>
          <li>
          ...
          <li>
            <strong className="text-zinc-900">이용 목적 및 보유 기간:</strong>{" "}
            맞춤형 광고 제공 및 광고 성과 측정을 위하여 이용하며, 보유 기간은
            메타의 데이터 정책에 따릅니다. 이 중 픽셀 기반 맞춤 타겟의 구성원
            유지 기간은 최대 180일입니다.
          </li>
          <li>
            <strong className="text-zinc-900">거부 방법:</strong> 제7조의2 ②항의
            방법(브라우저 쿠키 차단, 메타 광고 설정 등)으로 이전을 거부할 수
            있습니다. 메타 픽셀 관련 쿠키를 차단하거나 메타 광고 설정에서 맞춤형
            광고를 해제하더라도 서비스 이용에는 제한이 없으며, 맞춤형 광고 제공과
            광고 성과 측정만 이루어지지 않습니다. 다만 브라우저에서 모든 쿠키를
            차단하는 경우에는 제7조에 따라 로그인 유지 등 서비스 이용에 제한이
            있을 수 있습니다.
          </li>
          <li>
            <strong className="text-zinc-900">연락처:</strong> 이전받는 자의
            정보관리책임자 연락처 등 세부 정보는 제11조의 개인정보 보호책임자에게
            요청하시면 안내합니다.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            보유·이용 기간: 각 광고 사업자의 정책에 따릅니다. 메타의 경우 메타의
            데이터 정책에 따르며, 이 중 픽셀 기반 맞춤 타겟의 구성원 유지 기간은
            최대 180일입니다. 네이버의 경우 네이버의 정책에 따릅니다.
          </li>
        </ul>
