      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-500 text-sm mt-2">
            ...
            보유 기간 구체화, 메타 맞춤 타겟 보유 기간을 비즈니스 도구 약관 문언에
            맞게 정정)
          </p>
        </div>
    ...
    <div className="space-y-8 text-sm text-zinc-600 leading-relaxed">
      ...
      <section>
        ...
        {/* 아래 메타 픽셀 국외 이전 블록 — 위 위탁 이전과 달리 서비스 기능과
            ...
            2026-07-22 3차 개정: 맞춤 타겟 유지 기간 '최대 180일' 삭제(사실 오류).
            ⚠️ 맞춤 타겟 유지 기간을 N일로 적지 말 것 — 메타 비즈니스 도구 약관에는
            일수 자체가 없고, N일은 광고 관리자의 제품 설정 상한일 뿐 보유기간
            보장이 아니다. 상한은 메타가 바꾸면 방침이 자동으로 틀려진다
            (2026-05-18 Purchase 이벤트 기반 맞춤 타겟 180→730일 확대, 기존 타겟
            자동 이관). 약관 문언("이벤트 데이터 최대 2년" + "타겟은 계정 도구로
            삭제할 때까지")만 인용할 것. 이 서비스는 결제 완료 시 Purchase 픽셀을
            실제로 발화하므로(charge/success/page.tsx) 과소 기재 위험이 크다 —
            방침에서 과소 기재는 과다 기재보다 위험하다.
            같은 문장이 제7조의2 '보유·이용 기간'에도 있으니 함께 고칠 것. */}
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            ...
            있으며, 해당 데이터로 생성된 맞춤 타겟은 서비스가 메타의 계정 도구를
            통해 삭제할 때까지 보유될 수 있습니다.
          </li>
          <li>
      ...
      {/* 제7조의2 — 2026-07-11 신설: 메타 픽셀 등 맞춤형 광고 도구 도입 대비 고지.
          ...
          보유기간으로 옮겨 적지 말 것).
          2026-07-22 3차 개정: 맞춤 타겟 유지 기간 '최대 180일' 삭제(사실 오류).
          ⚠️ 맞춤 타겟 유지 기간을 N일로 적지 말 것 — 근거와 배경은 제6조 메타
          국외 이전 블록 위의 주석 참조. 같은 문장이 제6조에도 있으니 함께 고칠 것.
      ...
      <section>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li>
            ...
            비즈니스 도구 약관에 따라 이벤트 데이터를 최대 2년간 보유할 수
            있으며, 해당 데이터로 생성된 맞춤 타겟은 서비스가 메타의 계정 도구를
            통해 삭제할 때까지 보유될 수 있습니다. 네이버의 경우 네이버가 별도로
            정한 기간에 따르며, 구체적인 기간은 네이버에 문의하여 확인하실 수
            있습니다.
          </li>
        </ul>
